...
export default function Home({ studioProjects, productions, teamMembers, clients, showreels, expertise }) {
  ...
  const CSS = `
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .sg-item:nth-child(7n+1){grid-column:span 7}.sg-item:nth-child(7n+2){grid-column:span 5}.sg-item:nth-child(7n+3){grid-column:span 4}.sg-item:nth-child(7n+4){grid-column:span 5}.sg-item:nth-child(7n+5){grid-column:span 3}.sg-item:nth-child(7n+6){grid-column:span 5}.sg-item:nth-child(7n+7){grid-column:span 7}
    .sg-thumb{aspect-ratio:16/6;width:100%;position:relative;overflow:hidden;background:#060606}
    .sg-item:nth-child(7n+2) .sg-thumb,.sg-item:nth-child(7n+5) .sg-thumb{aspect-ratio:3/4}
    .sg-item:nth-child(7n+3) .sg-thumb{aspect-ratio:1}
    ...
    .pg-item:nth-child(6n+1){grid-column:span 5}.pg-item:nth-child(6n+2){grid-column:span 7}.pg-item:nth-child(6n+3){grid-column:span 4}.pg-item:nth-child(6n+4){grid-column:span 4}.pg-item:nth-child(6n+5){grid-column:span 4}.pg-item:nth-child(6n+6){grid-column:span 12}
    .pg-thumb{aspect-ratio:16/6;width:100%;position:relative;overflow:hidden;background:#060606}
    .pg-item:nth-child(6n+1) .pg-thumb{aspect-ratio:3/4}.pg-item:nth-child(6n+3) .pg-thumb{aspect-ratio:1}.pg-item:nth-child(6n+5) .pg-thumb{aspect-ratio:3/4}.pg-item:nth-child(6n+6) .pg-thumb{aspect-ratio:21/5}
